...
<head>
    ...
    <title><?php echo $page_title ?? 'Hospital Portal'; ?> - <?php echo SITE_NAME; ?></title>
...
<body>
    <div class="container">
        <nav class="top-nav">
            ...
            <div class="nav-user">
                <div class="user-info">
                    <div class="user-name"><?php echo htmlspecialchars($_SESSION['hospital_name']); ?></div>
